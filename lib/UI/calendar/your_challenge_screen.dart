...
class YourChallengeScreen extends StatefulWidget {
  ...
  YourChallengeScreen(this.date, this.challenge, this.isSelected);

  @override
  State<YourChallengeScreen> createState() => _ChallengeScreenState();
}

class _ChallengeScreenState extends State<YourChallengeScreen> {
  @override
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                ToMainButton.CustomWidget('Календарь радости', YourCalendar()),
                Container(
